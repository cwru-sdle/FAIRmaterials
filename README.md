...
## Location of XRD worked example

Click [here](https://github.com/cwru-sdle/FAIRmaterials/tree/main/worked-Example-XRaySample) for the XRD worked example files.
