...
#### Namespace sheet
![\label{fig:namespacesheet}](namespacesheet.png)

#### Ontology info sheet
![\label{fig:ontoinfosheet}](ontoinfosheet.png)

#### Value type sheet
![\label{fig:valtypesheet}](valtypesheet.png)

#### Relationship definition sheet
![\label{fig:reldefsheet}](reldefsheet.png)

#### Variable definition sheet
![\label{fig:vardefsheet}](vardefsheet.png)


## How to run the package
### In Python
Execute the package with the  command line, FAIRmaterials --options. 
...
### In R
Execute the package with the process_ontology_files function. 
